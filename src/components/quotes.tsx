import { Alimjan, Me, Timurbek, quote } from "@/assets";
...
const quotes: CardType = [
  {
    ...
    special: t("Основатель AralHub"),
    text: t("Найти идеальные таланты жизненно важно для роста бизнеса. Мы помогаем вам привлекать профессионалов, которые соответствуют вашим целям и требованиям, гарантируя долгосрочный успех. Благодаря их проактивному подходу мы эффективно расширили нашу деятельность, сохранив бюджет."),
  },
  {
    img: Me,
    title: "Искандер",
    special: t("Frontend разработчик"),
    text: t("Найти подходящую команду нелегко. Мы упрощаем этот процесс, предоставляя первоклассных специалистов, которые эффективно работают в вашем рабочем процессе и обеспечивают результаты в рамках бюджета. Благодаря их опыту мы смогли сократить расходы и улучшить сроки выполнения."),
  },
  {
    img: Alimjan,
    title: "Алимжан Имниаминов",
    special: t("Backend разработчик"),
    text: t("Сотрудничайте с профессионалами, которые привносят инновации и поднимают ваши проекты на новый уровень. Наши индивидуальные решения обеспечивают качество и долгосрочное сотрудничество для вашего растущего бизнеса. Их команда быстро адаптировалась к нашим требованиям и привнесла свежие идеи в наш продукт."),
  },
];
  ...
  return (
    <Card className="gap-6 lg:pt-20 lg:pb-32 lg:gap-32" variant="primary">
      <Title
        text={
          <>
           {t("Способ создания отличного программного обеспечения")}
          </>
        }
      />
